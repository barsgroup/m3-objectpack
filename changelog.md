...
- Добавлены изменения для совместимости с Django версии 1.7:
    - Корректировка импортов из django.conf.urls
    - Указана минимальная поддерживаемая версия Django - 1.4
- Добавлены изменения для совместимости с Django версии 1.5:
